...
#+begin_src elisp
  ...
  (use-package hydra-posframe
    ...
    :custom
    (hydra-posframe-poshandler 'posframe-poshandler-window-bottom-right-corner))
...
#+begin_src elisp
  (use-package popweb
    :straight (popweb :type git :host github :repo "xhcoding/popweb" :branch "feature/cookie" :build nil)
    :commands (popweb-dict-eudic-input)
    ...
    (setq popweb-config-location (expand-file-name "popweb" user-emacs-directory))
    (require 'popweb-dict)
