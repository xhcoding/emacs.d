...
#+begin_src elisp
  (use-package faces
    ...
    (default
     ((t (:font ,(font-xlfd-name (font-spec :family "Cascadia Code PL"))
                :height 120))))
    (fixed-pitch
     ((t (:inherit default))))
    :config
...
#+begin_src elisp
  (use-package olivetti
    :straight t
    :defer t
    :hook (prog-mode text-mode outline special-mode)
    )
#+end_src
...
#+begin_src elisp
  (use-package eaf
    :straight (emacs-application-framework :type git :host github :repo "emacs-eaf/emacs-application-framework"
                          ...
                          :build nil)
    :defer t
    :commands (eaf-open eaf-open-browser eaf-open-this-buffer eaf-open-pdf-from-history)
    :init
    ;; 手动添加到 load-path
...
#+begin_src elisp
  ...
  (use-package aichat
    :load-path (lambda () (expand-file-name "Personal/emacs-aichat" my-code-dir))
    :commands (aichat-bingai-chat aichat-bingai-assistant aichat-bingai-replace-or-insert aichat-openai-translate-to-english)
    :config
